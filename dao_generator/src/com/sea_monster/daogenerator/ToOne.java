...
public class ToOne {
    ...
    public ToOne(Schema schema, Entity sourceEntity, Entity targetEntity, Property[] fkProperties, boolean useFkProperty, boolean ignoreNull) {
        this.schema = schema;
    ...
    public ToOne(Schema schema, Entity sourceEntity, Entity targetEntity, Property[] fkProperties, boolean useFkProperty) {
        this(schema, sourceEntity, targetEntity, fkProperties, useFkProperty, false);
    }
